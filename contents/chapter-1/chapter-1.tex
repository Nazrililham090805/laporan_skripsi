...
\begin{enumerate}
	\item Data sanad hadis menyimpan informasi relasi guru-murid antarperawi yang belum terstruktur sebagai representasi graf pengetahuan. Relasi tersebut perlu diekstraksi melalui tahap pra-pemrosesan dan dimodelkan sebagai \textit{Knowledge Graph} berbentuk graf berarah berbobot agar jaringan keilmuan Islam dapat dianalisis secara komputasional.
	\item Setiap perawi dalam jaringan sanad menempati posisi yang berbeda-beda dengan tingkat peran dan pengaruh yang tidak dapat diukur secara intuitif. Pengukuran kuantitatif menggunakan metrik sentralitas \textit{Social Network Analysis} (SNA) diperlukan untuk mengidentifikasi perawi-perawi kunci yang memiliki posisi strategis dalam jaringan secara objektif.
	\item Hasil analisis jaringan sanad hadis yang selama ini hanya tersedia dalam bentuk statis atau melalui perangkat lunak khusus membatasi akses bagi peneliti, mahasiswa, dan masyarakat umum. Oleh karena itu, sistem \textit{front-end} berbasis web dengan visualisasi graf interaktif perlu dikembangkan agar hasil analisis dapat dieksplorasi secara langsung tanpa instalasi perangkat lunak tambahan.
\end{enumerate}

\section{Tujuan Penelitian}

Penelitian ini bertujuan untuk mengembangkan \textit{Front-End Knowledge Graph} Keagamaan Ilmuwan Islam dengan memanfaatkan data sanad hadis dan pendekatan \textit{Social Network Analysis} (SNA). Tujuan penelitian ini adalah:
...
\begin{enumerate}
	...
	\item Mengembangkan sistem \textit{front-end} berbasis web dengan visualisasi graf interaktif yang memungkinkan peneliti, mahasiswa, dan masyarakat umum mengeksplorasi jaringan perawi serta hasil analisis sentralitas secara langsung tanpa instalasi perangkat lunak tambahan.
\end{enumerate}	
...
\begin{enumerate}
	...
	\item Analisis jaringan menggunakan metode \textit{Social Network Analysis} (SNA) dengan 5 metrik sentralitas, yaitu \textit{in degree centrality}, \textit{out degree centrality}, \textit{eigenvector centrality}, \textit{closeness centrality} dan \textit{betweenness centrality}.
