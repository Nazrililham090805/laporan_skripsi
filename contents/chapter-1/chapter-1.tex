...
\begin{enumerate}
	\item \textit{Knowledge Graph} berdasarkan data sanad hadis pada penelitian terdahulu masih memiliki keterbatasan dalam tahap pra-pemrosesan data, sehingga relasi guru-murid antarperawi belum terstruktur secara optimal untuk dianalisis secara komputasional.
	\item Penelitian terkait jaringan sanad hadis umumnya berhenti pada tahap visualisasi hubungan antarperawi tanpa mengkaji lebih dalam peran dan pengaruh masing-masing perawi dalam jaringan tersebut secara kuantitatif.
	\item Keterbatasan antarmuka \textit{Knowledge Graph} jaringan perawi hadis pada penelitian terdahulu yang berbasis perangkat lunak \textit{desktop} khusus menyebabkan hasil analisis sulit diakses dan dieksplorasi secara interaktif oleh peneliti, mahasiswa, maupun masyarakat umum.
\end{enumerate}
