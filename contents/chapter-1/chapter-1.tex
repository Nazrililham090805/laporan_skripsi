...
\begin{enumerate}
	\item Penelitian ini menggunakan dataset publik \textit{Sanadset 650K: Data on Hadith Narrators} sebagai sumber data utama. Pengolahan data hanya dilakukan pada kolom sanad yang tersedia dalam dataset tersebut, tidak mencakup kolom lainnya seperti matan maupun metadata hadis.
	...
	\item Analisis jaringan menggunakan metode \textit{Social Network Analysis} (SNA) dibatasi pada tiga metrik sentralitas, yaitu \textit{in degree centrality}, \textit{out degree centrality}, \textit{eigenvector centrality}, \textit{closeness centrality} dan \textit{betweenness centrality}.
