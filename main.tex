...
\author{Moh. Nazril Ilham}{22/493142/TK/54000}
% Input the thesis' title
\title{ANALISIS JARINGAN KEILMUAN ISLAM PADA SANAD HADIS BERBASIS \textit{KNOWLEDGE GRAPH} DAN \textit{SOCIAL NETWORK ANALYSIS} SERTA VISUALISASINYA PADA DASHBOARD INTERAKTIF}
...
\addsupervisor{Widyawan, S.T., M.Sc., Ph.D.}{NIP. 197312042002121001}
...
\usepackage{array}
\usepackage{amsmath}
\usepackage{xurl} % agar tautan (\url{}) panjang dapat berpindah baris tanpa melewati margin
% Buat paragraf di dalam item daftar (enumerate/itemize) ikut menjorok seperti paragraf biasa
\setlist[enumerate,1]{listparindent=\parindent}
\setlist[itemize,1]{listparindent=\parindent}
...
\chapterstatementjpg{contents/statement/PengesahanIlham.jpg}
